/************************************************************
 * WINDOW
 *   This class is the main display window.
 ************************************************************/
class Window
{
  // Some variables
  ...
  // These are the text fields for new keys
  Textfield name;
  Textfield p;
  Textfield q;
  ...
  /********************************************************
   * Function for displaying the file selection buttons
   ********************************************************/
  ...
  /********************************************************
   * Function for displaying the file contents
   ********************************************************/
  void displayFileUI()
  {
    clearWindow();
  ...
  /********************************************************
   * Function for clearing the window for new output
   ********************************************************/
  void clearWindow()
  {
    WindowController.getGroup("newKeyWindow").hide();
